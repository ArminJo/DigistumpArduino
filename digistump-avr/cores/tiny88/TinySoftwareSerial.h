...
extern "C"{
  void uartDelay() __attribute__ ((naked,used)); //used attribute required to prevent LTO from throwing it out.
  uint8_t getch();
...
{
  public: //should be private but required by extern "C" {} functions.
  uint8_t _rxmask;
  uint8_t _txmask;
  uint8_t _txunmask;
